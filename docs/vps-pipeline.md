...
The bounded DNS implementation has been validated by six consecutive successful production cycles through 2026-09-22 01:19 UTC. Compute stages for those six runs were 494 s, 489 s, 523 s, 488 s, 545 s, and 470 s, versus 5736 s in the last production cycle before the bounded per-source parallel resolver was deployed. End-to-end durations were 35m35s, 36m27s, 34m40s, 32m34s, 36m48s, and 32m38s. Every run reported coverage_complete=true; passive country coverage varied normally between 115 and 117 countries and the latest three runs retained roughly 1.12 million deduplicated nodes. No OOM, publication failure, or cleanup failure was observed. Treat hostname-only shared caching plus bounded per-source parallel DNS as the measured production baseline; keep the four source-worker limit unless later runtime evidence supports another change.
