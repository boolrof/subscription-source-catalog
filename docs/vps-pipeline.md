...
The bounded DNS implementation was validated by three consecutive successful production cycles after deployment. The cycles completed on 2026-09-19 13:22 UTC, 2026-09-20 01:23 UTC, and 2026-09-20 13:21 UTC. Their compute stages were 494 s, 489 s, and 523 s respectively, versus 5736 s in the last production cycle before the bounded per-source parallel resolver was deployed. End-to-end durations were 35m35s, 36m27s, and 34m40s. All three runs reported coverage_complete=true; passive country coverage remained 116-117 countries, and each run produced more than 1.13 million deduplicated nodes. No OOM or publication failure was observed. Treat hostname-only shared caching plus bounded per-source parallel DNS as the measured production baseline; keep the four source-worker limit unless later runtime evidence supports another change.
