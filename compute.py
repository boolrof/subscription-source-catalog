...
def main() -> int:
    ...
    print(json.dumps({
        ...
        "inspect_elapsed_ms_max": metrics.get("sources", {}).get("inspect_elapsed_ms_max", 0),
        "inspect_slow_ge_8s": metrics.get("sources", {}).get("inspect_slow_ge_8s", 0),
        "inspect_slow_failed_ge_8s": metrics.get("sources", {}).get("inspect_slow_failed_ge_8s", 0),
        "failure_error_counts": metrics.get("sources", {}).get("failure_error_counts", {}),
        "stage_elapsed_ms_max": metrics.get("sources", {}).get("stage_elapsed_ms_max", {}),
        "dns_cache_entries": metrics.get("sources", {}).get("dns_cache_entries", 0),
        "dns_cache_hits": metrics.get("sources", {}).get("dns_cache_hits", 0),
        "dns_cache_misses": metrics.get("sources", {}).get("dns_cache_misses", 0),
        ...
        "geo_batch_requests": metrics.get("geo", {}).get("batch_requests", 0),
        "geo_batch_ips": metrics.get("geo", {}).get("batch_ips", 0),
        "geo_batch_failures": metrics.get("geo", {}).get("batch_failures", 0),
